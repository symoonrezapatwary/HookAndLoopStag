...
const slackPayload = (testEnv) => {
    const rootDir = app_root_path_1.default.path;
    const resultFilePath = fast_glob_1.default.sync(`${rootDir}/**/results.json`);
    const results = JSON.parse(fs_1.default.readFileSync(resultFilePath[0]).toString());
    const body = {
        blocks: [
            {
                type: 'divider',
